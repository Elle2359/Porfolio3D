...
import flappy from'~/assets/flappy-bird game.jpeg';
import proshop from '~/assets/appleipro Shop.jpeg';
    ...
    <Fragment>
      <ProjectContainer className={styles.slice}>
        ...
        <ProjectHeader
          ...
          url="https://www.piecex.com/eng/source-code/Flappy-bird-game-3593"
          roles={roles}
        />
        <ProjectSection padding="top">
          <ProjectSectionContent>
            <ProjectImage
              srcSet={`${flappy} 800w, ${sliceAppLarge} 1920w`}
              width={800}
              height={500}
